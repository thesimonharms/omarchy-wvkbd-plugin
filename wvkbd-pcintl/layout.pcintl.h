...
static struct key keys_full[] = {
  /* Function key row with Esc and Del flanking */
  ...
  {"=", "+", 1.0, Code, KEY_EQUAL},
  {"Bksp", "Bksp", 1.5, Code, KEY_BACKSPACE, .scheme = 1},
  {"", "", 0.0, EndRow},
  ...
  {"/", "?", 1.0, Code, KEY_SLASH},
  {"Shift", "Shift", 2.75, Mod, Shift, .scheme = 1},
  {"", "", 0.0, EndRow},

  /* Modifier row */
  {"Ctrl", "Ctrl", 1.25, Mod, Ctrl, .scheme = 1},
  {"Super", "Super", 1.25, Mod, Super, .scheme = 1},
  {"Alt", "Alt", 1.25, Mod, Alt, .scheme = 1},
  {"", "Tab", 7.0, Code, KEY_SPACE},
  {"AltGr", "AltGr", 1.25, Mod, AltGr, .scheme = 1},
